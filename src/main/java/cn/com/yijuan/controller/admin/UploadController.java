...
import cn.com.yijuan.model.admin.file.UeditorConfigVO;
import cn.com.yijuan.model.admin.file.UploadResultVO;
    ...
    public Object upload(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (action.equals(IMAGE_UPLOAD)) {
            try {
                ...
                UploadResultVO uploadResultVM = new UploadResultVO();
            ...
            UeditorConfigVO ueditorConfigVM = new UeditorConfigVO();
